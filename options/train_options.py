...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--patience', type=float, default=300, help='patience for early stopping')
        ...
        self.parser.add_argument('--save_steps_freq', type=int, default=2000, help='frequency of saving checkpoints')
