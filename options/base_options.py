...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='MP-20')
        self.parser.add_argument('--res', type=int, default=32, help='dataset resolution')
        self.parser.add_argument('--trunc_thres_max_tot', type=float, default=100.0, help='threshold for truncated total charge density.')
        self.parser.add_argument('--trunc_thres_min_tot', type=float, default=0.0001, help='threshold for truncated total charge density.')
        self.parser.add_argument('--niggli', type=bool, default=False, help='whether to use reduced cell.')
        self.parser.add_argument('--primitive', type=bool, default=False, help='whether to use primitive cell.')
        self.parser.add_argument('--graph_method', type=str, default='crystalnn', help='method for GNN application.')
        self.parser.add_argument('--preprocess_workers', type=int, default=16, help='set number of wokers for parallel jobs during preprocessing ')
        self.parser.add_argument('--property', default=None, help='target property of interest')
        self.parser.add_argument('--tolerance', type=float, default=0.1, help='target property of interest')
        self.parser.add_argument('--use_space_group', type=bool, default=False, help='to consider symmetry or not')
        self.parser.add_argument('--lattice_scale_method', type=str, default='scale_length', help='method for scale lattice parameters during the preprocessing')
        ...
        self.parser.add_argument(
                            '--model', type=str, default='vqvae_chgdiff',
                            help='chooses which model to use.'
                        )
        self.parser.add_argument('--ckpt', type=str, default=None, help='ckpt to load.')

        # diffusion stuff
        self.parser.add_argument('--df_cfg', type=str, default='configs/chargediff_uncond.yaml', help="diffusion model's config file")
        self.parser.add_argument('--df_ckpt', type=str, default=None, help='diffusion ckpt to load.')

        # vqvae stuff
        self.parser.add_argument('--vq_model', type=str, default='VQVAE_ChargeDIFF', help='for choosing the vqvae model to use.')
        ...
        self.parser.add_argument('--vq_ckpt', type=str, default=None, help='saved vqvae model')        
        ...
        self.parser.add_argument("--local_rank", "--local-rank", type=int, default=0, help="local rank for distributed training")
