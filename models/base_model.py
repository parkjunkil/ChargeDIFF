# Reference: The code is adpated from the LDM repo: https://github.com/yccyenchicheng/SDFusion
...
def create_model(opt):
    ...
    # For chargediff training (both for unconditional and conditional) 
    elif 'chargediff' in opt.model:
        from models.chargediff_model import CHARGEDIFF_Model
        model = CHARGEDIFF_Model()
